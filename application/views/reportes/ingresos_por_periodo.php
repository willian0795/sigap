        ...
        if($anio!="" &&  (($("#mes").val()!="0" && document.getElementById('radio_mensual').checked==true)	
        	...
        	|| document.getElementById('radio_anual').checked==true
          	...
          	if(document.getElementById('radio_pdf').checked==true && tipo==""){
          		window.open(site+"/reportes/ingresos_por_periodo/pdf?anio="+$anio+"&tipo="+type+"&value="+value,"_blank");
          	}else if(document.getElementById('radio_excel').checked==true && tipo==""){
          		window.open(site+"/reportes/ingresos_por_periodo/excel?anio="+$anio+"&tipo="+type+"&value="+value,"_blank");
          	}else{
          		var html="<embed src='"+site+"/reportes/ingresos_por_periodo/html?anio="+$anio+"&tipo="+type+"&value="+value+"' width='100%' height='700px'>";
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="align-self-center" align="center">
                <h3 class="text-themecolor m-b-0 m-t-0">Ingresos por periodo</h3>
            </div>
        </div>
        <div class="row">
