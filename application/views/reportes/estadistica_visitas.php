        ...
        if($anio!="" &&  (($("#mes").val()!="0" && document.getElementById('radio_mensual').checked==true)	
        	...
        	|| document.getElementById('radio_anual').checked==true
          	...
          	if(document.getElementById('radio_pdf').checked==true && tipo==""){
          		window.open(site+"/reportes/estadistica_visitas/pdf?anio="+$anio+"&tipo="+type+"&value="+value,"_blank");
          	}else if(document.getElementById('radio_excel').checked==true && tipo==""){
          		window.open(site+"/reportes/estadistica_visitas/excel?anio="+$anio+"&tipo="+type+"&value="+value,"_blank");
          	}else{
          		var html="<embed src='"+site+"/reportes/estadistica_visitas/html?anio="+$anio+"&tipo="+type+"&value="+value+"' width='100%' height='700px'>";
