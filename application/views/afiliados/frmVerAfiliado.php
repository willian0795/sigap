                                 ...
                                 <div class="row">
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control "  style="text-transform:uppercase" disabled="true" value="<?php echo $item['NOMBRES_AFILIADO']; ?>"  id="nombresAfiliado"  name="nombresAfiliado">
                                                </div>
                                         </div>
                                         <div class="col-md-6">
                                                <div class="form-group">
                                                        <label for="apellidosAfiliado">Apellidos Afiliado</label>
                                                        <input type="text" class="form-control " style="text-transform:uppercase"  disabled="true" id="apellidosAfiliado" value="<?php echo $item['APELLIDOS_AFILIADO']; ?>" name="apellidosAfiliado">
                                                </div>
                                         </div>
                                         ...
                                         <div class="col-md-6">
                                                <div class="form-group">
                                                        <label for="edadAfiliado">Menor de edad</label>
                                                          <select style="width: 100%" id="edadAfiliado" onchange="cambia()"  disabled="true"  class="form-control" name="edadAfiliado">
                      ...
                      <section>
                              <div class="row">
                                      <div class="col-md-6">
                                                <div class="form-group">
                                                        <label for="sexoAfiliado">Sexo Afiliado</label>
                                                          <select style="width: 100%" id="sexoAfiliado"   disabled="true" class="form-control" name="sexoAfiliado">
                                         ...
                                         <div class="col-md-6">
                                                <div class="form-group">
                                                        <label for="estadoAfiliado">Estado</label>
                                                          <select style="width: 100%" id="estadoAfiliado"  disabled="true"  class="form-control" name="estadoAfiliado">
                               ...
                               <div class="row">
                                    <div class="col-md-12">
                                                <div class="form-group">
                                                        <label for="asociacionAfiliado">Asociacion del Afiliado</label>
                                                        <select style="width: 100%" id="asociacionAfiliado" disabled="true"  class="form-control" name="asociacionAfiliado">
